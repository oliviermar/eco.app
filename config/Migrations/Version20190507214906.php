 ...
 */
final class Version20190507214906 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE address (id UUID NOT NULL, user_id UUID DEFAULT NULL, name VARCHAR(255) NOT NULL, street VARCHAR(255) NOT NULL, zipcode VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, street_number INT DEFAULT NULL, address_complement VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE eco_user (id UUID NOT NULL, username VARCHAR(255) NOT NULL, roles TEXT NOT NULL, password TEXT NOT NULL, score INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN eco_user.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN eco_user.roles IS \'(DC2Type:array)\'');
        $this->addSql('CREATE TABLE rank (id UUID NOT NULL, name VARCHAR(50) NOT NULL, picto VARCHAR(255) NOT NULL, score_start INT NOT NULL, score_end INT NOT NULL, level INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN rank.id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE offer (id UUID NOT NULL, address_id UUID DEFAULT NULL, user_id UUID DEFAULT NULL, title VARCHAR(50) NOT NULL, description TEXT NOT NULL, quantity VARCHAR(255) DEFAULT NULL, status VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
